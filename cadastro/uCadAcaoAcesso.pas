...
begin
  inherited;
  if FileExists('C:\ProjetoDelphi\Win32\Config\CadastroAcaoAcesso') then
     grdListagem.Columns.LoadFromFile('C:\ProjetoDelphi\Win32\Config\CadastroAcaoAcesso');
end;
...
begin
  ...
  grdListagem.Columns.SaveToFile('C:\ProjetoDelphi\Win32\Config\CadastroAcaoAcesso');
end;
