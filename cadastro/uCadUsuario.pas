...
uses
  ...
  Vcl.Grids, Vcl.DBGrids, Vcl.StdCtrls, Vcl.Buttons, Vcl.Mask, Vcl.ExtCtrls, Vcl.ComCtrls, cCadUsuario, uEnum, uDTMConexao,
  cAcaoAcesso;
...
begin
  ...
  if Assigned(oUsuario) then
     FreeAndNil(oUsuario);
  grdListagem.Columns.SaveToFile('C:\ProjetoDelphi\Win32\Config\CadastroDeUsuario');
end;
...
begin
  inherited;
  if FileExists('C:\ProjetoDelphi\Win32\Config\CadastroDeUsuario') then
     grdListagem.Columns.LoadFromFile('C:\ProjetoDelphi\Win32\Config\CadastroDeUsuario');
end;
